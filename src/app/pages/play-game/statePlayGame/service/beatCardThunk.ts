...
export const beatCardThunk = createAsyncThunk<{ cardToBeat: string, cardToBeatBy: string}, { gameId: number; cardToBeat: string; cardToBeatBy: string }, { rejectValue: string }>(
    'beatCard',
